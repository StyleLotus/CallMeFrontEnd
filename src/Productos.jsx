	...
	return (
		<>
				...
				<div className="mx-auto">
					...
					<div className="m-auto flex-col">
						<form className="w-10/12" onSubmit={handleSubmit}>
							...
							<input type="file" id="imagen" name="imagen" onChange={handleImageChange}></input>
							<label for="Color" className="block">
								Color:
							</label>
							...
							<span className="m-auto flex flex-row justify-center items-center">
								<input
									type="submit"
									value="AGREGAR"
									className="m-4 cursor-pointer p-2 rounded font-bold bg-green-600 hover:bg-green-700 hover:text-white"
								></input>
			...
			<div className="flex m-auto">
				<div
					className="w-72 h-96 border-2 rounded-2xl border-transparent shadow-2xl"
				...
				>
					...
					<span className="flex flex-row">
						...
						<h2 className="flex justify-center items-center rounded p-2 m-auto w-20 shadow-2xl bg-white">
							{CantidadActual}
						</h2>
					</span>
					<h2 className="flex justify-end p-2">
